...
if( $seoPlugin == 'allinone' && function_exists( 'aioseo_breadcrumbs' ) ) {
	...
	add_filter('rank_math/frontend/breadcrumb/html', [ '\PowerElements\Helpers', 'pe_rank_math_crumbs_html' ], 10, 3 );
	rank_math_the_breadcrumbs();
	remove_filter('rank_math/frontend/breadcrumb/settings', [ '\PowerElements\Helpers', 'pe_rank_math_crumbs_settings' ] );
